...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SeenBody', function() {
      beforeEach(function() {
        instance = new ApiWhatsgateru.SeenBody();
      });

      it('should create an instance of SeenBody', function() {
        // TODO: update the code to test SeenBody
        expect(instance).to.be.a(ApiWhatsgateru.SeenBody);
      });
