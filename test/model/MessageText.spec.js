...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MessageText', function() {
      beforeEach(function() {
        instance = new ApiWhatsgateru.MessageText();
      });

      it('should create an instance of MessageText', function() {
        // TODO: update the code to test MessageText
        expect(instance).to.be.a(ApiWhatsgateru.MessageText);
      });
